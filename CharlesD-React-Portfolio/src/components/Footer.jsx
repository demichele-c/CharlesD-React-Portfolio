    ...
    <footer className="bg-white dark:bg-gray-900 text-gray-900 dark:text-white py-6">
      <div className="container mx-auto text-center">
        ...
        <div className="mt-4 flex justify-center space-x-6">
          ...
          <a href="https://stackoverflow.com/users/your-stackoverflow-id" target="_blank" rel="noopener noreferrer" className="hover:text-teal-500 dark:hover:text-teal-400">
