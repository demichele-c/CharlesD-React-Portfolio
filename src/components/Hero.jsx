...
const Hero = () => {
  ...
  return (
    <section 
      className="relative w-full h-screen bg-cover bg-center sm:bg-cover sm:bg-top" 
      style={{ backgroundImage: 'url(/assets/images/chuck-the-diver.jpg)' }}
    >
      <div className="absolute inset-0 bg-black bg-opacity-50 flex flex-col justify-center items-center text-center text-white px-4">
        <h1 className="text-3xl sm:text-5xl md:text-7xl font-display animate-fadeIn">
          Charles DeMichele
        </h1>
        <p className={`text-lg sm:text-xl md:text-2xl mt-4 ${fadeClass}`}>
          {text}
        </p>
        <a href="/projects" className="mt-8 px-6 py-3 bg-teal-500 hover:bg-teal-400 transition rounded-full text-white text-sm sm:text-base md:text-lg">
          View My Work
        </a>
      </div>
    </section>
